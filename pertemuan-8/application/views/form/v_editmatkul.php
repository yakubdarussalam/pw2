...
<div class="container">
  ...
  <div class="col col-sm-8">
      <div class="form-group">
        ...
        <input type="ematextil" class="form-control" name="kode_mk" aria-describedby="emailHelp" value="<?=$u->kode_mk;?>" readonly>
  ...
  <div class="col col-sm-8">
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="nama_mk" aria-describedby="emailHelp" value="<?=$u->nama_mk;?>">
      </div>
  </div>
    <div class="col col-sm-8">
      <div class="form-group">
